...
import asyncio
from Nodes import Page_details  ,get_actions ,action_router,dispatch_actions
...
async def main():
    ...
    task='search about albert einstien and get me information about its research available as text  .'
